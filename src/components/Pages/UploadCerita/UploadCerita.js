...
export const UploadCerita = () => {
  ...
  const daftar_fakultas=["FITB","FMIPA", "FSRD","FTI","FTMD", "FTTM","FTSL","SAPPK","SBM","SF","SITH","STEI"]
  ...
  const daftar_jurusan=
    {
      ...
      FSRD:["SENI RUPA","KRIA","DESAIN INTERIOR","DESAIN KOMUNIKASI VISUAL","DESAIN PRODUK"],
      FTI : ["TEKNIK KIMIA","TEKNIK FISIKA","TEKNIK INDUSTRI","MANAJEMEN REKAYASA INDUSTRI","TEKNIK PANGAN","TEKNIK BIOENERGI DAN KEMURDI"],
      FTMD : ["TEKNIK MESIN","TEKNIK DIRGANTARA","TEKNIK MATERIAL"],
      FTTM : ["TEKNIK PERTAMBANGAN","TEKNIK PERRMINYAKAN","TEKNIK GEOFISIKA","TEKNIK METALURGI"],
      FTSL : ["TEKNIK SIPILTEKNIK LINGKUNGAN","TEKNIK KELAUTAN","TEKNIK DAN PENGELOLAAN SUMBER DAYA AIR","REKAYASA INFRASTRUKTUR LINGKUNGAN"],
      SAPPK : ["ARSITEKTUR","PERENCANAAN WILAYAH DAN KOTA"],
      SBM : ["MANAJEMEN","KEWIRAUSAHAAN"],
      SF : ["BIOLOGI","MIKROBIOLOGI","REKAYASA HAYATI","REKAYASA PERTANIAN","REKAYASA KEHUTANAN","TEKNOLOGI PASCA PANEN"],
      STEI : ["TEKNIK ELEKTRO","TEKNIK INFORMATIKA","TEKNIK TENAGA LISTRIK","TEKNIK TELEKOMUNIKASI","SISTEM DAN TEKNOLOGI INFORMASI","TEKNIK BIOMEDIS"]
    }
      ...
      <div className="UploadCerita-wrapper">
        <div className="UploadCerita-containter">
          ...
          <div className="UploadCerita-form">
            ...
            <Dropdown label="Fakultas" hasLabel value={fakultas} options={daftar_fakultas} handleChange={setFakultas}/>
            {fakultas!="" && <Dropdown label="Jurusan" hasLabel value={jurusan} options={daftar_jurusan[fakultas]} handleChange={setJurusan}/>}
